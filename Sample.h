...
Real sample(const Point& o1, const Point& a1, const Point& b1, const Point& o2, const Point& a2, const Point& b2, std::pair<Point, Point>& pointPair)
{
...
Real distanceSample(const OBB& a, const OBB& b, std::pair<Point, Point>& pointPair) {
	Real sqrDist{ 1000 };
...
#pragma omp parallel for
	...
	for (int i = 0; i < 6; ++i)
	{
		...
		for (const auto& bface : faces)
		{
			...
			Real dist = sample(o1, a1, b1, o2, a2, b2, curPair);
